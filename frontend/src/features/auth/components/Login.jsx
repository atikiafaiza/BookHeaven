...
export const Login = () => {
  ...
  // handles login status and dispatches reset actions
  useEffect(() => {
  ...
  return (
    <Stack width={'100vw'} height={'100vh'} flexDirection={'row'} sx={{ overflowY: 'hidden' }}>
      {/* Left side with image instead of animation */}
      {!is900 && (
        <Stack bgcolor={'black'} flex={1} justifyContent={'center'} alignItems={'center'}>
          <Box
            component="img"
            src="/images/book-2.jpg" // Replace with your desired image path
