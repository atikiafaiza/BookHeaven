...
export const AdminDashBoard = () => {
  ...
  return (
    ...
    <motion.div style={{position:"fixed",backgroundColor:"white",height:"100vh",padding:'1rem',overflowY:"scroll",width:is500?"100vw":"30rem",zIndex:500}}  variants={{show:{left:0},hide:{left:-500}}} initial={'hide'} transition={{ease:"easeInOut",duration:.7,type:"spring"}} animate={isProductFilterOpen===true?"show":"hide"}>
        ...
        <Stack rowGap={2} mt={4} >
            <Typography sx={{cursor:"pointer"}} variant='body2'>Drama</Typography>
            <Typography sx={{cursor:"pointer"}} variant='body2'>Fiction</Typography>
            <Typography sx={{cursor:"pointer"}} variant='body2'>Non-Fiction</Typography>
            <Typography sx={{cursor:"pointer"}} variant='body2'>Romance</Typography>
            <Typography sx={{cursor:"pointer"}} variant='body2'>Comedy</Typography>
        </Stack>
