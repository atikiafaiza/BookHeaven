            ...
            <Stack rowGap={3}>
                ...
                <Stack flexDirection={'row'} >
                    ...
                    <FormControl fullWidth>
                        <InputLabel id="brand-selection">Author</InputLabel>
                ...
                {/* <Stack>
                    ...
                    <Stack>
                        <Typography variant='h6' fontWeight={400} gutterBottom>Cover Image</Typography>
                        <TextField {...register("coverImage", { required: "Cover Image URL is required" })} />
                    </Stack>
